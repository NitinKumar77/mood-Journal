...
function Description() {
  return (
    <div className=" max-h-[23.4rem] max-w-[27.5rem] mt-[3.75rem]  ml-[6.25rem] mr-[4.26rem] max-sm:m-0">
      ...
      <div className=" py-12 text-black  text-lg font-normal leading-normal dark:text-white max-sm:pb-1 ">
        ...
        insights and contribute to your well-being.
      </div>
    </div>
  );
}
